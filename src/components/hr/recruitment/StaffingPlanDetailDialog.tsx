    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {isArabic
              ? 'أدخل تفاصيل المنصب المطلوب. سيتم حساب الشواغر والميزانية تلقائياً.'
              : 'Enter the position details. Vacancies and budget will be calculated automatically.'}
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={isArabic ? 'DEPT001' : 'DEPT001'}
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={
                          isArabic ? 'القسم القانوني' : 'Legal Department'
                        }
                        {...field}
                      />
                    </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={isArabic ? 'القسم القانوني' : 'القسم القانوني'} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={isArabic ? 'محامي أول' : 'Senior Lawyer'}
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {isArabic ? 'المسمى الوظيفي بالعربية' : 'Designation (Arabic)'}
                    </FormLabel>
                    <FormControl>
                      <Input placeholder={isArabic ? 'محامي أول' : 'محامي أول'} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {isArabic ? 'عدد المناصب المخططة' : 'Planned Positions'} *
                    </FormLabel>
                    <FormControl>
            ...
            {vacancies > 0 && (
              <Alert>
                ...
                <AlertDescription>
                  {isArabic ? 'الشواغر' : 'Vacancies'}: <strong>{vacancies}</strong>{' '}
                  {isArabic ? 'منصب شاغر' : 'vacant positions'}
                </AlertDescription>
              </Alert>
            )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    {isArabic ? 'التكلفة المقدرة لكل منصب' : 'Estimated Cost Per Position'} *
                  </FormLabel>
                  <FormControl>
                    <Input
                      type="number"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel>
                      {isArabic ? 'تاريخ التعيين المتوقع' : 'Expected Hire Date'}
                    </FormLabel>
                    <Popover>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      {isArabic
                        ? 'اشرح سبب الحاجة لهذا المنصب'
                        : 'Explain why this position is needed'}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {isArabic ? 'المبرر بالعربية' : 'Justification (Arabic)'}
                    </FormLabel>
                    <FormControl>
                      <Textarea
                        placeholder={isArabic ? 'المبرر...' : 'Justification...'}
                        rows={4}
                        {...field}
                      />
                    </FormControl>
