...
export const smartButtonConfigs: Record<EntityType, SmartButtonConfig[]> = {
  ...
  case: [
    {
      ...
      navigateTo: `${ROUTES.dashboard.cases.detail('{id}')}#hearings`,
      clickable: true,
    },
    {
      id: 'documents',
    ...
    },
    {
      ...
      navigateTo: `${ROUTES.dashboard.cases.detail('{id}')}#tasks`,
      clickable: true,
    },
    {
      id: 'timeEntries',
    ...
    },
    {
      ...
      navigateTo: `${ROUTES.dashboard.cases.detail('{id}')}#notes`,
      clickable: true,
    },
  ],
  ...
  lead: [
    ...
    },
    {
      ...
      navigateTo: `${ROUTES.dashboard.crm.leads.detail('{id}')}#notes`,
      clickable: true,
    },
  ],
}
