...
import {
  ...
  Play, Download, Share2, Copy, Activity, Users,
  UserPlus, Phone, MessageCircle, Mail
} from 'lucide-react'
import {
  reportStatusLabels,
...
export function CrmReportsListView() {
  ...
  // Filter for CRM section reports
  ...
  const getCategoryColor = (category: ReportCategory) => {
    const colors: Record<string, string> = {
      ...
      opportunities: 'bg-emerald-100 text-emerald-700',
      interactions: 'bg-cyan-100 text-cyan-700',
      communications: 'bg-indigo-100 text-indigo-700',
      client_satisfaction: 'bg-pink-100 text-pink-700',
