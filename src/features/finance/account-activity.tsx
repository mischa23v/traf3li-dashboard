...
import { Search, Filter, Download, Calendar, TrendingUp, TrendingDown, Receipt, FileText, CreditCard, Check, Clock, AlertCircle } from 'lucide-react'
      ...
      <Main dir="rtl">
        <div className="max-w-[1800px] mx-auto p-6">
          ...
          <div className="space-y-6">
            {Object.entries(groupedActivities).map(([date, dateActivities]: any) => (
              <div key={date}>
                {/* Date Header */}
