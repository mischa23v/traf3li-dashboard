            ...
            <>
                ...
                <Main fluid={true} className="bg-[#f8f9fa] flex-1 w-full p-6 lg:p-8">
                    <div className="max-w-[1600px] mx-auto mb-6">
                        <Link to={ROUTES.dashboard.finance.recurringInvoices.list} className="inline-flex items-center text-slate-500 hover:text-navy transition-colors">
                ...
                <Main fluid={true} className="bg-[#f8f9fa] flex-1 w-full p-6 lg:p-8">
                    ...
                    <div className="bg-white rounded-3xl p-12 text-center border border-slate-100 shadow-sm">
                        <div className="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4">
                            <RefreshCw className="h-8 w-8 text-slate-600" aria-hidden="true" />
                        </div>
                        ...
                        <Button asChild className="bg-brand-blue hover:bg-blue-600 text-white px-8">
                            <Link to={ROUTES.dashboard.finance.recurringInvoices.list}>
                                        ...
                                        <div className="p-6 space-y-3">
                                            {recurring.generatedTransactionIds.length === 0 ? (
                                                <div className="text-center text-slate-500 py-8">
                                                    <FileText className="h-8 w-8 mx-auto mb-2 opacity-20" aria-hidden="true" />
