                                                ...
                                                <div className="flex items-center justify-between pt-4 border-t border-slate-200/50">
                                                    <div className="flex items-center gap-6">
                                                        <div className="text-center">
                                                            <div className="text-xs text-slate-600 mb-1">التشغيل التالي</div>
                                                            <div className="font-bold text-[#022c22]">{formatDate(transaction.nextRunDate)}</div>
                                                        </div>
                                                        <div className="text-center">
                                                            <div className="text-xs text-slate-600 mb-1">تم التشغيل</div>
                                                            <div className="font-bold text-[#022c22]">{transaction.timesRun} مرة</div>
                                                        </div>
                                                        {transaction.lastRunDate && (
                                                            <div className="text-center hidden sm:block">
                                                                <div className="text-xs text-slate-600 mb-1">آخر تشغيل</div>
