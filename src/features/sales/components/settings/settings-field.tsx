 ...
 *
 * Reusable form field component for sales settings with bilingual support.
 * Handles different field types: text, number, boolean, select, textarea, etc.
 *
 * @module features/sales/components/settings/settings-field
 */
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <Input
            ...
            max={field.max}
            step={field.step}
            className={field.type === 'currency' ? 'pl-16' : ''}
            dir="ltr"
          />
          {field.type === 'percent' && (
