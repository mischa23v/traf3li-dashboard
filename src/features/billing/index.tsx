    ...
    <>
      ...
      <Main className="bg-slate-50" dir="rtl">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          <div className="border-slate-200 bg-gradient-to-br from-slate-50 to-white border rounded-lg p-6">
            <div className="flex items-center justify-between mb-3">
              <div className="h-10 w-10 rounded-lg bg-slate-100 flex items-center justify-center">
                <TrendingUp className="h-5 w-5 text-slate-700" />
              </div>
              <span className="text-xs px-2 py-1 border border-slate-200 rounded-md">هذا الشهر</span>
            </div>
          ...
          <div className="border-slate-200 bg-gradient-to-br from-slate-50 to-white border rounded-lg p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs px-2 py-1 border border-slate-200 rounded-md">معلق</span>
            </div>
          ...
          <div className="border-slate-200 bg-gradient-to-br from-slate-50 to-white border rounded-lg p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs px-2 py-1 border border-slate-200 rounded-md">متأخر</span>
            </div>
          ...
          <div className="border-slate-200 bg-gradient-to-br from-slate-50 to-white border rounded-lg p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs px-2 py-1 border border-slate-200 rounded-md">صافي</span>
            </div>
        ...
        <div className="grid grid-cols-3 gap-6 mb-6">
          {/* Cash Flow Chart */}
          <div className="border-slate-200 col-span-2 bg-white border rounded-lg p-6">
          ...
          {/* Performance Metrics */}
          <div className="border-slate-200 bg-white border rounded-lg p-6">
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="border-slate-200 bg-white border rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs px-2 py-1 bg-red-600 text-white rounded-md">{outstandingInvoices.filter(i => i.urgent).length} عاجل</span>
            </div>
            <div className="space-y-3">
              {outstandingInvoices.map((invoice: any, idx) => (
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-right">
                      ...
                      {invoice.daysOverdue > 0 && (
                        <span className="text-xs px-2 py-1 mt-1 bg-red-600 text-white rounded-md inline-block">متأخر {invoice.daysOverdue} يوم</span>
                      )}
                    </div>
                  </div>
