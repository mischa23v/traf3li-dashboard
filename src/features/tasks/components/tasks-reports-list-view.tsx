...
import {
  ...
  Play, Download, Share2, Copy, Activity, CheckSquare,
  ListTodo, Users, Target, Briefcase
} from 'lucide-react'
import {
  reportStatusLabels,
...
export function TasksReportsListView() {
  ...
  // Filter for tasks section reports
  ...
  const getCategoryColor = (category: ReportCategory) => {
    const colors: Record<string, string> = {
      ...
      time_tracking: 'bg-cyan-100 text-cyan-700',
      goals: 'bg-amber-100 text-amber-700',
      workload: 'bg-orange-100 text-orange-700',
      deadlines: 'bg-red-100 text-red-700',
