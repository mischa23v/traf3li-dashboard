...
export function PayrollRunsListView() {
    ...
    const handleViewRun = (runId: string) => {
        navigate({ to: '/dashboard/hr/payroll-runs/$runId', params: { runId } })
    }

    const handleEditRun = (runId: string) => {
        navigate({ to: '/dashboard/hr/payroll-runs/new', search: { editId: runId } })
    }
                                    ...
                                    <div key={run._id} className={`bg-[#F8F9FA] rounded-2xl p-6 border transition-all group ${selectedIds.includes(run._id) ? 'border-emerald-500 bg-emerald-50/30' : 'border-slate-100 hover:border-emerald-200'}`}>
                                        ...
                                        <div className="grid grid-cols-5 gap-4 pt-4 border-t border-slate-200/50">
                                            <div className="text-center">
                                                <div className="text-xs text-slate-400 mb-1">الموظفين</div>
                                            ...
                                            <div className="text-center">
                                                <div className="text-xs text-slate-400 mb-1">إجمالي الرواتب</div>
                                            ...
                                            <div className="text-center">
                                                <div className="text-xs text-slate-400 mb-1">صافي الرواتب</div>
                                        ...
                                        <div className="flex justify-end mt-4">
                                            <Link to={`/dashboard/hr/payroll-runs/${run._id}` as any}>
