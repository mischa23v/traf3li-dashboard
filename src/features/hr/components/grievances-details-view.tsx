                      ...
                      <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          ...
                          <div className="p-4 bg-slate-50 rounded-xl">
                            ...
                            <Badge className={getColorClasses(GRIEVANCE_CATEGORY_LABELS[grievance.grievanceCategory || 'individual']?.color)}>
                              {GRIEVANCE_CATEGORY_LABELS[grievance.grievanceCategory || 'individual']?.ar}
                            </Badge>
                          </div>
                          <div className="p-4 bg-slate-50 rounded-xl">
                            <p className="text-xs text-slate-500 mb-1">الأولوية</p>
                            <Badge className={getColorClasses(GRIEVANCE_PRIORITY_LABELS[grievance.priority]?.color)}>
                              {GRIEVANCE_PRIORITY_LABELS[grievance.priority]?.ar}
                            </Badge>
                          </div>
                          <div className="p-4 bg-slate-50 rounded-xl">
                            <p className="text-xs text-slate-500 mb-1">الخطورة</p>
                            <Badge className={getColorClasses(GRIEVANCE_SEVERITY_LABELS[grievance.severity || 'moderate']?.color)}>
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {grievance.anonymousComplaint && (
                            <Badge className="bg-purple-100 text-purple-700">
                              <Eye className="w-3 h-3 ms-1" aria-hidden="true" />
                              مجهولة الهوية
                            </Badge>
                          )}
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            {grievance.resolution.outcome && (
                              <div className="p-4 bg-white rounded-xl">
                                ...
                                <Badge className={getColorClasses(OUTCOME_TYPE_LABELS[grievance.resolution.outcome]?.color)}>
