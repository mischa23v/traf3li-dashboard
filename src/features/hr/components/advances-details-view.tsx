                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex justify-between">
                              ...
                              <Badge className={`bg-${ADVANCE_TYPE_LABELS[advance.advanceType]?.color}-100 text-${ADVANCE_TYPE_LABELS[advance.advanceType]?.color}-700`}>
                                {ADVANCE_TYPE_LABELS[advance.advanceType]?.ar}
                              </Badge>
                            </div>
                            <div className="flex justify-between">
                              <span className="text-slate-500">الأولوية</span>
                              <Badge className={`bg-${URGENCY_LABELS[advance.urgency]?.color}-100 text-${URGENCY_LABELS[advance.urgency]?.color}-700`}>
