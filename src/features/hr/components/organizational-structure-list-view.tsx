                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-3">
                                <div className={`p-2 bg-${UNIT_TYPE_LABELS[unit.unitType]?.color || 'slate'}-100 rounded-xl`}>
                                  <TypeIcon className={`w-5 h-5 text-${UNIT_TYPE_LABELS[unit.unitType]?.color || 'slate'}-600`} />
                                </div>
                                <div>
