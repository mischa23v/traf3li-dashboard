...
import { Search, Filter, Download, Calendar, TrendingUp, TrendingDown, FileText, CreditCard, Check, Clock, AlertCircle, Receipt } from 'lucide-react'
    ...
    <>
      <Header>
        <div className='flex items-center gap-6 flex-1'>
          <h1 className="text-xl font-bold">نشاط الحساب</h1>
        ...
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-bold mb-1">{todayActivities}</div>
                  <div className="text-xs text-muted-foreground">أنشطة اليوم</div>
                </CardContent>
              </Card>

              {/* Total Income */}
              <Card className="border-green-200 dark:border-green-800 bg-gradient-to-br from-green-50 to-background dark:from-green-950">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-xs text-green-700 dark:text-green-300">إجمالي المقبوضات</div>
                </CardContent>
              </Card>

              {/* Total Expenses */}
              <Card className="border-red-200 dark:border-red-800 bg-gradient-to-br from-red-50 to-background dark:from-red-950">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-xs text-red-700 dark:text-red-300">إجمالي المصروفات</div>
                </CardContent>
              </Card>

              {/* Pending Invoices */}
              <Card className="border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-50 to-background dark:from-amber-950">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="text-3xl font-bold text-amber-900 dark:text-amber-100 mb-1">{pendingInvoices}</div>
                  <div className="text-xs text-amber-700 dark:text-amber-300">فواتير معلقة</div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-sm font-semibold mb-4">الأنشطة حسب النوع</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-sm font-semibold mb-4">المستخدمون النشطون</h3>
                  <div className="space-y-3">
                    {Object.entries(
                      activities.reduce((acc, activity) => {
                    ...
                    .map(([user, count], idx) => (
                      <div key={idx} className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-gradient-to-br from-muted to-background flex items-center justify-center">
                          <span className="text-xs font-bold">{count}</span>
                        </div>
                        <div className="flex-1">
                          <div className="text-xs font-medium">{user}</div>
                          <div className="text-[10px] text-muted-foreground">{count} نشاط</div>
                        </div>
                      </div>
                    ))}
                  </div>
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-sm font-semibold mb-4">إحصائيات سريعة</h3>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-950 rounded-lg">
                      <div>
                        <div className="text-xs text-muted-foreground mb-1">دفعات مستلمة</div>
                    ...
                    <div className="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-950 rounded-lg">
                      <div>
                        <div className="text-xs text-muted-foreground mb-1">فواتير مرسلة</div>
          ...
          <div className="bg-card rounded-lg border mb-6">
            ...
            <div className="px-6 py-4 bg-muted/50 border-b">
              <div className="grid grid-cols-4 gap-4">
                ...
                <div>
                  <label className="text-xs font-medium text-muted-foreground mb-2 block text-right">نوع النشاط</label>
                  <Select>
                    <SelectTrigger className="w-full text-right" dir="rtl">
                ...
                <div>
                  <label className="text-xs font-medium text-muted-foreground mb-2 block text-right">المستخدم</label>
                  <Select>
                    <SelectTrigger className="w-full text-right" dir="rtl">
                      <SelectValue placeholder="الكل" />
                    </SelectTrigger>
                              ...
                              <div className="flex items-start justify-between mb-2">
                                <div>
                                  <div className="flex items-center gap-2 mb-1">
                                    <h3 className="text-sm font-bold">{activity.type}</h3>
                                ...
                                <div className="text-left">
                                  ...
                                  {activity.amount && (
                                    <div className={`text-lg font-bold ${activity.amount >= 0 ? 'text-green-700 dark:text-green-400' : 'text-red-700 dark:text-red-400'}`}>
