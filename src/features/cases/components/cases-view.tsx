        ...
        <>
            ...
            <Main fluid={true} className="bg-slate-50/50 flex-1 w-full p-6 lg:p-8 space-y-8 rounded-tr-3xl shadow-inner border-r border-white/5 overflow-hidden font-['IBM_Plex_Sans_Arabic']">
                <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    {/* Hero Section - Contained Emerald Card */}
                    <div className="bg-emerald-950 rounded-2xl p-6 lg:p-8 relative overflow-hidden text-white mb-8">
                        {/* Background Effects */}
                        <div className="absolute top-0 start-0 w-full h-full overflow-hidden z-0 pointer-events-none">
                            <div className="absolute top-[-10%] start-[-10%] w-[40%] h-[40%] bg-emerald-500/20 rounded-full blur-[100px]"></div>
                            <div className="absolute bottom-[-10%] end-[-10%] w-[40%] h-[40%] bg-teal-500/10 rounded-full blur-[100px]"></div>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
                                <div>
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <span className="text-emerald-200 text-sm">{caseData.court}</span>
                                        <span className="text-slate-400 text-sm">•</span>
                                        <span className="text-emerald-200 text-sm font-mono">{caseData.id}</span>
                                    </div>
                                    <Link to={`/dashboard/cases/${caseData.id}` as any} className="hover:underline decoration-emerald-400 underline-offset-4">
                                        <h1 className="text-2xl lg:text-3xl font-bold leading-relaxed mb-2 hover:text-emerald-400 transition-colors">
                                            {caseData.title}
                                        </h1>
                                    </Link>
                                </div>
                                <div className="flex gap-3">
                                    <Button className="bg-emerald-500 hover:bg-emerald-600 text-white border-0 h-11 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-emerald-950">
                                        <Plus className="w-4 h-4 ms-2" />
                                        إجراء جديد
                                    </Button>
                                    <Button variant="outline" className="bg-white/5 border-white/20 text-white hover:bg-white/10 h-11 rounded-xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-white/5 rounded-2xl border border-white/10 backdrop-blur-sm">
                                <div className="space-y-2">
                                    <div className="flex justify-between text-sm mb-2">
                                        <span className="text-emerald-200">نسبة الإنجاز</span>
                                ...
                                <div className="flex justify-between items-center border-e border-white/10 pe-6">
                                    <div>
                                        <div className="text-emerald-200 text-sm mb-1">قيمة المطالبة</div>
                                        <div className="text-2xl font-bold">{caseData.claimAmount.toLocaleString()} ر.س</div>
                                    </div>
                                </div>
                                <div className="flex justify-between items-center border-e border-white/10 pe-6">
                                    <div>
                                        <div className="text-emerald-200 text-sm mb-1">الربح المتوقع</div>
                                        <div className="text-2xl font-bold text-emerald-400">{caseData.expectedProfit.toLocaleString()} ر.س</div>
                                    </div>
                                </div>
                            </div>

                            <div className="flex flex-wrap gap-6 mt-6 text-sm text-emerald-200/80">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                        ...
                                        <div className="relative border-e-2 border-slate-100 pe-6 space-y-8">
                                            {hearings.map((event, index) => (
                                                <div key={index} className="relative">
                                                    <div className={`absolute -end-[31px] top-1 w-4 h-4 rounded-full border-2 border-white ${index === 0 ? 'bg-emerald-600' : 'bg-slate-300'}`}></div>
                                                    <div className="space-y-2">
                                                        <div className="flex justify-between items-start">
                                                            <h4 className={`font-bold text-sm ${index === 0 ? 'text-slate-800' : 'text-slate-600'}`}>{event.title}</h4>
                                                        </div>
                        ...
                        <Card className="lg:col-span-8 border-none shadow-none bg-transparent">
                            <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="w-full">
                                <TabsList className="w-full justify-start bg-slate-100 p-1 rounded-xl border border-slate-200 mb-6 h-auto flex-wrap gap-1">
                                    <TabsTrigger
                                        value="overview"
                                        className="rounded-lg px-4 py-2 text-sm font-medium data-[state=active]:bg-emerald-950 data-[state=active]:text-white data-[state=inactive]:text-slate-600 transition-all"
                                    >
                                        نظرة عامة
                                    </TabsTrigger>
                                    <TabsTrigger
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <Card className="border-slate-200 shadow-sm rounded-2xl">
                                                <CardHeader className="pb-3 border-b border-slate-100 bg-slate-50/50">
                                                    <CardTitle className="text-base font-bold text-slate-800">ملخص القضية</CardTitle>
                                                </CardHeader>
                                                <CardContent className="pt-4 space-y-4">
                                                    <div className="flex justify-between">
                                                        <span className="text-slate-500 text-sm">رقم القضية</span>
                                                        <span className="font-mono font-bold text-slate-800">{caseData.id}</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                    ...
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span className="font-bold text-slate-800">{caseData.judge}</span>
                                                    </div>
                                                </CardContent>
                                            </Card>
                                            ...
                                            <Card className="border-slate-200 shadow-sm rounded-2xl">
                                                <CardHeader className="pb-3 border-b border-slate-100 bg-slate-50/50">
                                                    <CardTitle className="text-base font-bold text-slate-800">الموقع والاختصاص</CardTitle>
                                                </CardHeader>
                                                <CardContent className="pt-4 space-y-4">
                                                    <div className="flex justify-between">
                                                        <span className="text-slate-500 text-sm">المحكمة</span>
                                                        <span className="font-bold text-slate-800">{caseData.court}</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span className="text-slate-500 text-sm">مكتب العمل</span>
                                                        <span className="font-bold text-slate-800">{caseData.laborOffice}</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span className="text-slate-500 text-sm">المدينة</span>
                                                        <span className="font-bold text-slate-800">{parties.plaintiff.city}</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span className="text-slate-500 text-sm">نوع القضية</span>
                                                        <Badge variant="outline" className="text-slate-800 border-navy/20 rounded-lg">عمالية</Badge>
                                                    </div>
                                                </CardContent>
                                            </Card>
                                        </div>
                                            ...
                                            <Card className="border-slate-200 shadow-sm rounded-2xl">
                                                <CardHeader className="pb-3 border-b border-slate-100 bg-green-50/50">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <CardTitle className="text-base font-bold text-slate-800">المدعي</CardTitle>
                                                ...
                                                <CardContent className="pt-4 space-y-4">
                                                    <div className="space-y-1">
                                                        ...
                                                        <div className="font-bold text-slate-800">{parties.plaintiff.name}</div>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">رقم الهوية</span>
                                                            <div className="font-medium text-slate-800">{parties.plaintiff.id}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">الجنسية</span>
                                                            <div className="font-medium text-slate-800">{parties.plaintiff.nationality}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">تاريخ الميلاد</span>
                                                            <div className="font-medium text-slate-800">{parties.plaintiff.dobGregorian}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">المهنة</span>
                                                            <div className="font-medium text-slate-800">{parties.plaintiff.job}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">رقم الهاتف</span>
                                                            <div className="font-medium text-slate-800" dir="ltr">{parties.plaintiff.phone}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">المنطقة</span>
                                                            <div className="font-medium text-slate-800">{parties.plaintiff.region} - {parties.plaintiff.city}</div>
                                                        </div>
                                                    </div>
                                                </CardContent>
                                            </Card>
                                            ...
                                            <Card className="border-slate-200 shadow-sm rounded-2xl">
                                                <CardHeader className="pb-3 border-b border-slate-100 bg-amber-50/50">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <CardTitle className="text-base font-bold text-slate-800">المدعى عليه</CardTitle>
                                                ...
                                                <CardContent className="pt-4 space-y-4">
                                                    <div className="space-y-1">
                                                        ...
                                                        <div className="font-bold text-slate-800">{parties.defendant.name}</div>
                                                    </div>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">رقم السجل التجاري</span>
                                                            <div className="font-medium text-slate-800">{parties.defendant.crNo}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">رقم الملف</span>
                                                            <div className="font-medium text-slate-800">{parties.defendant.fileNo}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">الرقم الموحد</span>
                                                            <div className="font-medium text-slate-800">{parties.defendant.unifiedNo}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">نوع الجهة</span>
                                                            <div className="font-medium text-slate-800">{parties.defendant.type}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">المنطقة</span>
                                                            <div className="font-medium text-slate-800">{parties.defendant.region} - {parties.defendant.city}</div>
                                                        </div>
                                                    </div>
                                                </CardContent>
                                            </Card>
                                                ...
                                                <CardContent className="pt-4">
                                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                                        ...
                                                        <div className="space-y-1">
                                                            ...
                                                            <div className="font-bold text-slate-800">{workDetails.salary.toLocaleString()} ر.س</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">نوع العقد</span>
                                                            <div className="font-medium text-slate-800">{workDetails.contractType}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">رقم العقد</span>
                                                            <div className="font-medium text-slate-800">{workDetails.contractNo}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">تاريخ البدء</span>
                                                            <div className="font-medium text-slate-800">{workDetails.startDateGregorian}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                                            <span className="text-xs text-slate-400">تاريخ النهاية</span>
                                                            <div className="font-medium text-slate-800">{workDetails.lastDay}</div>
                                                        </div>
                                                        <div className="space-y-1">
                                    ...
                                    <TabsContent value="claims" className="mt-0 space-y-6">
                                                ...
                                                <div key={i} className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all">
                                                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <h4 className="font-bold text-slate-800">{claim.title}</h4>
                                                        ...
                                                        <div className="text-left">
                                                            <div className="text-xl font-bold text-slate-800">{claim.amount.toLocaleString()} ر.س</div>
                                                        </div>
                                                    </div>
                                                    <div className="bg-slate-50 rounded-xl p-3 grid grid-cols-2 gap-4 text-sm">
                                                        <div>
                                                            ...
                                                            <span className="font-medium text-slate-800">{claim.period.fromG}</span>
                                                        ...
                                                        <div>
                                                            ...
                                                            <span className="font-medium text-slate-800">{claim.period.toG}</span>
                                        ...
                                        <div className="bg-navy text-white p-6 rounded-2xl shadow-lg flex justify-between items-center relative overflow-hidden border border-white/5">
                                            ...
                                            <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
                                                <div className="absolute top-[-20%] right-[-10%] w-[60%] h-[120%] bg-emerald-950/10 rounded-full blur-[50px]"></div>
                                    ...
                                    <TabsContent value="hearings" className="mt-0 space-y-6">
                                        {hearings.map((hearing, i) => (
                                            <Card key={i} className="border-slate-200 shadow-sm overflow-hidden rounded-2xl">
                                                <div className={`h-2 ${hearing.isNew ? 'bg-emerald-950' : 'bg-slate-200'}`}></div>
                                                <CardContent className="p-6">
                                                    <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-6">
                                                        <div className="flex gap-4">
                                                            <div className="w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center text-slate-800 font-bold border border-slate-100">
                                                                {i + 1}
                                                            </div>
                                                            <div>
                                                                <div className="flex items-center gap-2 mb-1">
                                                                    <h3 className="font-bold text-lg text-slate-800">{hearing.title}</h3>
                                                                    {hearing.isNew && <Badge className="bg-emerald-950 rounded-md">جديدة</Badge>}
                                                        ...
                                                        {hearing.mechanism && (
                                                            <Badge variant="outline" className="text-slate-800 border-navy/20 rounded-lg">{hearing.mechanism}</Badge>
                                                        )}
                                                    </div>
                                                    ...
                                                    <div className="space-y-3">
                                                        <div className="text-sm font-bold text-slate-800">المذكرات والوثائق</div>
                                                        {hearing.memos.map((memo, j) => (
                                                            <div key={j} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-100">
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    <div>
                                                                        <div className="font-bold text-slate-800 text-sm">{memo.type}</div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                {documents.memos.map((doc, i) => (
                                                    <div key={i} className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition-all">
                                                        <div className="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-emerald-600 shrink-0">
