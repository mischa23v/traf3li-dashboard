          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2">
              <Badge
                variant="outline"
                className={(() => {
                  const statusColor = richDocumentStatusColors[document.status]
                  ...
                  return `rounded-md px-3 py-1 ${statusColorClasses[statusColor] || 'bg-gray-50 text-gray-700 border-gray-200'}`
                })()}
              >
