              ...
              <CardContent className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge
                    variant="outline"
                    className={(() => {
                      const statusColor = richDocumentStatusColors[doc.status]
                      ...
                      return `rounded-md px-2 text-xs ${statusColorClasses[statusColor] || 'bg-gray-50 text-gray-700 border-gray-200'}`
                    })()}
                  >
