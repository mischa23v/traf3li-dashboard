...
import {
    ...
    Scale, Flag, Briefcase, Hash, Sparkles, Save, ArrowRight
} from 'lucide-react'
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                                ...
                                <div className="pb-6 border-b border-slate-100">
                                    <div className="flex items-center gap-2 mb-4">
                                        ...
                                        <span className="text-sm font-medium text-slate-500">{t('cases.caseInfo', 'معلومات القضية')}</span>
                                    </div>
                                ...
                                <div className="border-t border-slate-100 pt-6">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <span className="text-sm font-medium text-slate-600">{t('cases.clientInfo', 'بيانات العميل')}</span>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-5 bg-slate-50 rounded-2xl border border-slate-100">
                                        <div className="space-y-2">
                                            <Label className="text-sm font-medium text-slate-600 flex items-center gap-1">
                                                ...
                                                {t('cases.clientName', 'اسم العميل')}
                                            </Label>
                                            <Input
                                                placeholder={t('cases.fullName', 'الاسم الكامل')}
                                                className={cn(
                                ...
                                <div className="border-t border-slate-100 pt-6">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <span className="text-sm font-medium text-slate-600">{t('cases.courtInfo', 'بيانات المحكمة')}</span>
                                    </div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-2">
                                                <Label className="text-sm font-medium text-slate-600 flex items-center gap-1">
                                                    ...
                                                    {t('cases.court', 'المحكمة')}
                                                </Label>
                                                <Input
                                                    placeholder={t('cases.courtPlaceholder', 'المحكمة العمالية - الرياض')}
                                                    className="rounded-xl border-slate-200 h-12 bg-white"
                                                    {...register('court')}
                                                />
                                            </div>
                                            ...
                                            <button type="button" className="flex items-center justify-between w-full text-sm group">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="text-start">
                                                        <span className="font-medium text-slate-700">{t('cases.laborDetails', 'تفاصيل القضية العمالية')}</span>
                                                        <p className="text-xs text-slate-500 mt-0.5">{t('cases.laborDetailsSubtitle', 'بيانات المدعي والشركة')}</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="space-y-6 p-5 bg-blue-50/50 rounded-2xl border border-blue-100">
                                                ...
                                                <div className="space-y-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <h4 className="font-medium text-blue-700">{t('cases.plaintiffDetails', 'بيانات المدعي (العامل)')}</h4>
                                                    </div>
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        <div className="space-y-2">
                                                            <Label className="text-sm font-medium text-slate-600">{t('cases.name', 'الاسم')}</Label>
                                                            <Input
                                                                className="rounded-xl border-slate-200 h-12 bg-white"
                                                        ...
                                                        <div className="space-y-2">
                                                            <Label className="text-sm font-medium text-slate-600">{t('cases.nationalId', 'رقم الهوية')}</Label>
                                                            <Input
                                                                className="rounded-xl border-slate-200 h-12 bg-white"
                                                        ...
                                                        <div className="space-y-2">
                                                            <Label className="text-sm font-medium text-slate-600">{t('cases.phoneLabel', 'الهاتف')}</Label>
                                                            <Input
                                                                className="rounded-xl border-slate-200 h-12 bg-white"
                                                ...
                                                <div className="space-y-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <h4 className="font-medium text-amber-700">{t('cases.companyDetails', 'بيانات الشركة (المدعى عليه)')}</h4>
                                                    </div>
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        <div className="space-y-2">
                                                            <Label className="text-sm font-medium text-slate-600">{t('cases.companyName', 'اسم الشركة')}</Label>
                                                            <Input
                                                                className="rounded-xl border-slate-200 h-12 bg-white"
                                                        ...
                                                        <div className="space-y-2">
                                                            <Label className="text-sm font-medium text-slate-600">{t('cases.commercialReg', 'السجل التجاري')}</Label>
                                                            <Input
                                                                className="rounded-xl border-slate-200 h-12 bg-white"
                                ...
                                <div className="flex items-center justify-end gap-4 pt-6 border-t border-slate-100">
                                    ...
                                    <Button
                                        ...
                                        className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-11 px-8 shadow-lg shadow-blue-500/20 font-medium min-w-[140px]"
                                    >
                                ...
                                <p className="text-xs text-slate-400 flex items-center justify-end gap-1">
                                    <Sparkles className="w-3 h-3" />
                                    {t('cases.allFieldsOptional', 'جميع الحقول اختيارية')}
                                </p>
                            </form>
                        </div>
                    </div>
