...
import { Calendar, MapPin, Users, Clock, Briefcase, Plus, Search, Download, Edit, Trash2, Eye, Building2, Scale, User, CheckCircle, X } from 'lucide-react'
...
export default function EventsPage() {
  ...
  const getTypeInfo = (type: any, _subType: any) => {
    if (type === 'court') {
      return {
        label: 'جلسة محكمة',
            ...
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 flex-1">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    variant={selectedFilter === 'upcoming' ? 'default' : 'secondary'}
                    className={selectedFilter === 'upcoming' ? '' : 'bg-blue-50 text-blue-700 hover:bg-blue-100'}
                  >
                    قادمة
                  </Button>
                  <Button
                    onClick={() => setSelectedFilter('completed')}
                    variant={selectedFilter === 'completed' ? 'default' : 'secondary'}
                    className={selectedFilter === 'completed' ? '' : 'bg-green-50 text-green-700 hover:bg-green-100'}
                  >
                    مكتملة
                  </Button>
                </div>
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  variant="secondary"
                  className={selectedType === 'all' ? 'bg-slate-200' : ''}
                >
                  الكل
                </Button>
                <Button
                  ...
                  variant="secondary"
                  className={selectedType === 'court' ? 'bg-purple-200 text-purple-900' : 'bg-purple-50 text-purple-700 hover:bg-purple-100'}
                >
                  محاكم
                </Button>
                <Button
                  ...
                  variant="secondary"
                  className={selectedType === 'labor_office' ? 'bg-orange-200 text-orange-900' : 'bg-orange-50 text-orange-700 hover:bg-orange-100'}
                >
                  مكتب العمل
                </Button>
                <Button
                  ...
                  variant="secondary"
                  className={selectedType === 'meeting' ? 'bg-blue-200 text-blue-900' : 'bg-blue-50 text-blue-700 hover:bg-blue-100'}
                >
                  اجتماعات
                </Button>
              </div>
            ...
            <div className="bg-white rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Button onClick={() => setSelectedEvent(null)} variant="ghost" size="icon">
                    <X className="h-5 w-5" />
                  </Button>
                </div>
                  ...
                  {selectedEvent.attendees && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedEvent.attendees.map((attendee: any, idx: any) => (
                  ...
                  {selectedEvent.agenda && (
                    <div>
                      ...
                      <ul className="space-y-1">
                        {selectedEvent.agenda.map((item: any, idx: any) => (
