...
import { DataTablePagination, DataTableViewOptions, DataTableFacetedFilter } from '@/components/data-table'
...
export function TemplatesTable({ data }: TemplatesTableProps) {
  ...
  const typeOptions = templateTypes.map((type) => ({
    value: type.value,
